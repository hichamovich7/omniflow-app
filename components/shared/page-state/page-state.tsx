...
const defaults: Record<
  PageStateVariant,
  { icon: LucideIcon; role?: 'alert'; iconClassName: string }
> = {
...
export function PageState({
  ...
  return (
    <section
      className={cn(
        'flex min-h-56 flex-col items-center justify-center rounded-xl border border-dashed border-border/60 bg-surface px-6 py-12 text-center',
        className
      )}
    ...
    >
      ...
      {description && <p className="text-body-secondary mt-1 max-w-md">{description}</p>}
